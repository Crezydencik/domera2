...
const COPY = {
  en: {
    ...
    electricityDescription: "Advance payments and confirmations for the selected building",
    electricityTariff: "Tariff",
    electricityPending: "Waiting for confirmation",
    electricityConfirmed: "Confirmed",
    electricityNoPayments: "No electricity advance payments yet.",
    electricityKwh: "kWh",
    electricityPaymentDate: "Payment date",
    electricityAcceptAdvance: "Accept advance",
    electricityAcceptConsumption: "Issue consumption invoice",
    electricityAdvanceTitle: "Accept electricity advance",
    electricityAdvanceDescription: "Choose an apartment and enter paid kWh. The amount is calculated from the tariff.",
    electricityConsumptionTitle: "Issue consumed electricity invoice",
    electricityConsumptionDescription: "Choose an apartment. If there is no previous reading, mark the current reading as the starting value.",
    electricityPreviousReading: "Previous reading",
    electricityCurrentReading: "Current reading",
    electricityUseAsStart: "Use current reading as starting value",
    electricitySaveStart: "Save starting value",
    electricityStartSaved: "Starting value saved. The next reading will be calculated from it.",
    electricityCurrentRequired: "Enter the current actual reading.",
    electricityCalculatedAmount: "Calculated amount",
    electricityAdvanceSubmit: "Accept advance",
    electricityAdvanceSaving: "Saving...",
    electricityAdvanceApartmentRequired: "Choose an apartment.",
    electricityAdvanceKwhRequired: "Enter advance kWh.",
    electricityAdvanceTariffMissing: "Electricity tariff is not configured.",
    electricityAdvanceCreated: "Electricity advance accepted.",
    electricityAdvanceCreateFailed: "Could not accept electricity advance.",
    electricityInvoiceCreated: "Electricity invoice issued.",
    electricityInvoiceCreateFailed: "Could not issue electricity invoice.",
    electricityConfirm: "Confirm",
    electricityConfirming: "Confirming...",
    electricityConfirmedToast: "Electricity payment confirmed.",
    electricityConfirmFailed: "Could not confirm electricity payment.",
  ...
  ru: {
    ...
    electricityTitle: "Электричество",
    electricityDescription: "Авансовые платежи и подтверждения по выбранному дому",
    electricityTariff: "Тариф",
    electricityPending: "Ожидает подтверждения",
    electricityConfirmed: "Подтверждено",
    electricityNoPayments: "Авансов по электричеству пока нет.",
    electricityKwh: "kWh",
    electricityPaymentDate: "Дата оплаты",
    electricityAcceptAdvance: "Принять аванс",
    electricityAcceptConsumption: "Выставить счёт",
    electricityAdvanceTitle: "Принять аванс за электричество",
    electricityAdvanceDescription: "Выберите квартиру и введите оплаченные kWh. Сумма рассчитается по тарифу.",
    electricityConsumptionTitle: "Выставить счёт за потреблённое электричество",
    electricityConsumptionDescription: "Выберите квартиру. Если предыдущего показания нет, отметьте текущее как стартовое.",
    electricityPreviousReading: "Предыдущее показание",
    electricityCurrentReading: "Текущее показание",
    electricityUseAsStart: "Использовать текущее показание как стартовое",
    electricitySaveStart: "Сохранить стартовое значение",
    electricityStartSaved: "Стартовое значение сохранено. Следующее показание будет считаться от него.",
    electricityCurrentRequired: "Введите текущее актуальное показание.",
    electricityCalculatedAmount: "Рассчитанная сумма",
    electricityAdvanceSubmit: "Принять аванс",
    electricityAdvanceSaving: "Сохраняем...",
    electricityAdvanceApartmentRequired: "Выберите квартиру.",
    electricityAdvanceKwhRequired: "Введите kWh аванса.",
    electricityAdvanceTariffMissing: "Тариф электричества не настроен.",
    electricityAdvanceCreated: "Аванс за электричество принят.",
    electricityAdvanceCreateFailed: "Не удалось принять аванс за электричество.",
    electricityInvoiceCreated: "Счёт за электричество выставлен.",
    electricityInvoiceCreateFailed: "Не удалось выставить счёт за электричество.",
    electricityConfirm: "Подтвердить",
    electricityConfirming: "Подтверждаем...",
    electricityConfirmedToast: "Платеж за электричество подтвержден.",
    electricityConfirmFailed: "Не удалось подтвердить платеж за электричество.",
    building: "Дом",
    apartment: "Квартира",
    period: "Период",
  ...
  lv: {
    ...
    electricityTitle: "Elektrība",
    electricityDescription: "Avansa maksājumi un apstiprinājumi izvēlētajai ēkai",
    electricityTariff: "Tarifs",
    electricityPending: "Gaida apstiprinājumu",
    electricityConfirmed: "Apstiprināts",
    electricityNoPayments: "Elektrības avansa maksājumu vēl nav.",
    electricityKwh: "kWh",
    electricityPaymentDate: "Maksājuma datums",
    electricityAcceptAdvance: "Pieņemt avansu",
    electricityAcceptConsumption: "Izrakstīt rēķinu",
    electricityAdvanceTitle: "Pieņemt elektrības avansu",
    electricityAdvanceDescription: "Izvēlieties dzīvokli un ievadiet apmaksātos kWh. Summa tiks aprēķināta pēc tarifa.",
    electricityConsumptionTitle: "Izrakstīt rēķinu par patērēto elektrību",
    electricityConsumptionDescription: "Izvēlieties dzīvokli. Ja iepriekšējā rādījuma nav, atzīmējiet pašreizējo kā sākuma vērtību.",
    electricityPreviousReading: "Iepriekšējais rādījums",
    electricityCurrentReading: "Pašreizējais rādījums",
    electricityUseAsStart: "Izmantot pašreizējo rādījumu kā sākuma vērtību",
    electricitySaveStart: "Saglabāt sākuma vērtību",
    electricityStartSaved: "Sākuma vērtība saglabāta. Nākamais rādījums tiks aprēķināts no tās.",
    electricityCurrentRequired: "Ievadiet pašreizējo aktuālo rādījumu.",
    electricityCalculatedAmount: "Aprēķinātā summa",
    electricityAdvanceSubmit: "Pieņemt avansu",
    electricityAdvanceSaving: "Saglabā...",
    electricityAdvanceApartmentRequired: "Izvēlieties dzīvokli.",
    electricityAdvanceKwhRequired: "Ievadiet avansa kWh.",
    electricityAdvanceTariffMissing: "Elektrības tarifs nav iestatīts.",
    electricityAdvanceCreated: "Elektrības avanss pieņemts.",
    electricityAdvanceCreateFailed: "Neizdevās pieņemt elektrības avansu.",
    electricityInvoiceCreated: "Elektrības rēķins izrakstīts.",
    electricityInvoiceCreateFailed: "Neizdevās izrakstīt elektrības rēķinu.",
    electricityConfirm: "Apstiprināt",
    electricityConfirming: "Apstiprina...",
    electricityConfirmedToast: "Elektrības maksājums apstiprināts.",
    electricityConfirmFailed: "Neizdevās apstiprināt elektrības maksājumu.",
