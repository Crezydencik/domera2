...
export default async function ManagementCompanyMeterReadingsPage() {
  const t = await getTranslations("meterReadings");
  
  const data = await getRoleDataBundle("managementCompany");

  return (
    <SectionCard title={t("managementCompanyTitle")} description={t("managementCompanyDescription")}>
