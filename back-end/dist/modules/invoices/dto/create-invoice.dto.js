...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ enum: ['owner', 'tenant', 'general'], description: 'Who should see/receive this invoice.' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsIn)(['owner', 'tenant', 'general']),
    __metadata("design:type", String)
], CreateInvoiceDto.prototype, "recipientType", void 0);
__decorate([
