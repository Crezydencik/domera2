...
const baseStyles = {
  ...
  button:
    'display:inline-block;margin:24px 0 34px;padding:13px 32px;border:1px solid #ef3340;border-radius:4px;color:#ef3340;text-decoration:none;font-size:16px;font-weight:700;',
